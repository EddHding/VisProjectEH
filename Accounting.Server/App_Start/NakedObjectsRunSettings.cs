...
namespace NakedObjects.Accounting {
    public class NakedObjectsRunSettings
    {
        ...
        private static string[] ModelNamespaces
        {
            get
            {
                return new string[] { "Accounting.Model" }; //Add top-level namespace(s) that cover the domain model
            }
        }
        ...
        private static Type[] Types
        {
            ...
            {
                return new Type[] {
                    typeof(Transaction), typeof(StartingTransaction), typeof(ProfitLossTransaction)
        ...
        public static EntityObjectStoreConfiguration EntityObjectStoreConfig()
        {
            ...
            config.UsingCodeFirstContext(() => new AccountingDbContext("NakedObjectsTemplate"));
            return config;
        }
